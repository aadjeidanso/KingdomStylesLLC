...
app.post('/create-checkout-session', async (req, res) => {
    ...
    try {
        const session = await stripe.checkout.sessions.create({
            ...
            mode: 'payment',
            success_url: 'https://kingdomstylesllc-834ac45d3d4b.herokuapp.com/booking.html',
            cancel_url: 'https://kingdomstylesllc-834ac45d3d4b.herokuapp.com/booking.html#appointment-form',
